...
def _generateThemeHexValues(fg, bg, red, green, yellow, blue, magenta, cyan):
    ...
    lch_colors = {
        # Main colors
        'mainBackground':       LCHabColor(5, 0, bg, obs, ill),
        'mainForeground':       LCHabColor(75, fgChroma, fg, obs, ill),
        'red':                  LCHabColor(60, 60, red, obs, ill),
        'green':                LCHabColor(60, 50, green, obs, ill), # strings
        'yellow':               LCHabColor(60, 55, yellow, obs, ill), # vars
        'blue':                 LCHabColor(60, 50, blue, obs, ill), # storage type
        'magenta':              LCHabColor(60, 60, magenta, obs, ill), # keywords
        'cyan':                 LCHabColor(60, 35, cyan, obs, ill), # comments
        'brightPink':           LCHabColor(75, 40, red-30, obs, ill),
        'brightLightGreen':     LCHabColor(80, 50, green-30, obs, ill),
        'brightOrange':         LCHabColor(80, 40, yellow-30, obs, ill),
        'brightLightBlue':      LCHabColor(80, 35, blue-30, obs, ill),
        'brightPurple':         LCHabColor(80, 34, magenta-30, obs, ill), # consts and tags
        'brightTurquoise':      LCHabColor(80, 50, cyan-30, obs, ill),
        'white':                LCHabColor(80, 0, 0, obs, ill),
        'brightWhite':          LCHabColor(100, 0, 0, obs, ill),
        'terminal.black':       LCHabColor(20, 0, 0, obs, ill),
        'terminal.brightBlack': LCHabColor(60, 0, 0, obs, ill),

        # Other backgrounds
        'black':    LCHabColor(0, 0, 0, obs, ill),
        'bg10':     LCHabColor(10, 0, bg, obs, ill),
        'bg15':     LCHabColor(15, 0, bg, obs, ill),
        'bg20':     LCHabColor(20, 0, bg, obs, ill),
        'bg25':     LCHabColor(25, 0, bg, obs, ill),
        'bg35':     LCHabColor(35, 0, bg, obs, ill),

        # Other foregrounds
        'fg45':     LCHabColor(45, fgChroma, fg, obs, ill),
        'fg60':     LCHabColor(60, fgChroma, fg, obs, ill),
        'fg90':     LCHabColor(90, fgChroma, fg, obs, ill),
        
        # Other colors
        'orange':       LCHabColor(60, 60, yellow-30, obs, ill),
        'darkRed':      LCHabColor(20, 20, red, obs, ill),
        'darkOrange':   LCHabColor(20, 20, yellow-30, obs, ill),
        'darkBlue':     LCHabColor(20, 20, blue, obs, ill),
        'dullRed':      LCHabColor(65, 27, red, obs, ill),
        'dullOrange':   LCHabColor(65, 27, yellow-30, obs, ill),
        'dullGreen':    LCHabColor(65, 27, green, obs, ill),
        'dullBlue':     LCHabColor(65, 20, blue, obs, ill),
...
def _generateJsonContent(name, colors):
    ...
    return {
        ...
        'colors': {
            ...
            'editorBracketHighlight.foreground1': colors['mainForeground'],
            ...
            'editorCodeLens.foreground': colors['mainForeground'],
            'editorError.foreground': colors['red'],
            'editorGroup.border': colors['fg45'],
            'editorGroup.dropBackground': colors['bg25'] + '80',
            'editorGroup.emptyBackground': colors['mainBackground'],
            'editorGroupHeader.noTabsBackground': colors['mainBackground'],
            'editorGroupHeader.tabsBackground': colors['bg10'],
            'editorGutter.addedBackground': colors['green'],
            'editorGutter.background': colors['mainBackground'],
            ...
            'editorLineNumber.activeForeground': colors['mainForeground'],
            ...
            'editorOverviewRuler.currentContentForeground': colors['mainForeground'] + '80',
            ...
            'editorOverviewRuler.wordHighlightStrongForeground': colors['mainForeground'] + 'cc',
            ...
            'peekView.border': colors['brightLightGreen'],
            ...
            'peekViewTitleDescription.foreground': colors['mainForeground'] + 'b3',
            ...
            'statusBar.foreground': colors['mainForeground'],
            'statusBar.noFolderBackground': colors['bg20'],
            'tab.activeBackground': colors['mainBackground'],
            'tab.activeForeground': colors['fg90'],
            'tab.border': colors['mainBackground'],
            ...
            'titleBar.inactiveForeground': colors['mainForeground'],
            'widget.shadow': colors['black'] + '5c',

            # TERMINAL
            'terminal.foreground':          colors['mainForeground'],
            'terminal.background':          colors['mainBackground'],
            ...
            'terminal.ansiBrightBlue':      colors['brightLightBlue'],
            'terminal.ansiCyan':            colors['cyan'],
            'terminal.ansiBrightCyan':      colors['brightTurquoise'],
            'terminal.ansiGreen':           colors['green'],
            'terminal.ansiBrightGreen':     colors['brightLightGreen'],
            'terminal.ansiMagenta':         colors['magenta'],
            'terminal.ansiBrightMagenta':   colors['brightPurple'],
            'terminal.ansiRed':             colors['red'],
            'terminal.ansiBrightRed':       colors['brightPink'],
            'terminal.ansiYellow':          colors['yellow'],
            'terminal.ansiBrightYellow':    colors['brightOrange'],
